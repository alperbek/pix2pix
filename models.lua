...
function defineD_basic(input_nc, output_nc, ndf, use_sigmoid)
    n_layers = 3
    return defineD_n_layers(input_nc, output_nc, ndf, n_layers, use_sigmoid)
end

-- rf=1
function defineD_pixelGAN(input_nc, output_nc, ndf, use_sigmoid)
...
--            286 if n=5
--            574 if n=6
function defineD_n_layers(input_nc, output_nc, ndf, n_layers, use_sigmoid)
  if n_layers==0 then
